...
function playFourIsInfinity(message, num) {
  if (!((parseInt(num) >= 0) && (parseInt(num) <= 999))) return message.channel.send('That is not a valid number. Please enter a number from 0 to 999.').catch(global.logger.error);
